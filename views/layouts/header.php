            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            <li><a href="/card/"><i class="fa fa-shopping-cart"></i> Корзина <span class="count-product-in-card"></span></a></li>
                            <?php if(User::isGuest()):?>
                                <li><a href="/user/login/"><i class="fa fa-lock"></i> Вход</a></li>
                            <?php else:?>
                                <?php if($_SESSION['admin']):?>
                                    <li><a href="/admin/"><i class="fa fa-user"></i> Панель администратора</a></li>
                                <?php endif;?>
